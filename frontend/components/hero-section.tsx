    ...
    <div className="overflow-hidden rounded-3xl bg-[#d4c8b4]">
      <div className="flex flex-col gap-6 p-8 md:flex-row md:items-center md:gap-10 md:p-10">
        <div className="mx-auto flex-shrink-0 md:mx-0">
          {/* Reemplazamos <img> con BookCard */}
          <BookCard 
            title="Cien Años de Soledad"
            author="Gabriel García Márquez"
            coverUrl={undefined} // Envia undefined para forzar la portada provisional
            coverVariant="cv3" // Cambia a cv1, cv2, etc. para elegir el color
            rating={4.8}
            className="w-[170px]" 
          />
        </div>
